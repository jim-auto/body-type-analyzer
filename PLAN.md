...
現行の [next.config.ts](/body-type-analyzer/next.config.ts) は以下です。
...
ホームの実装中心は [app/page.tsx](/body-type-analyzer/app/page.tsx) と [HomePageClient.tsx](/body-type-analyzer/components/HomePageClient.tsx) です。
...
現在の分布データ生成は [distributions.ts](/body-type-analyzer/lib/distributions.ts) が担当しています。
...
診断 UI 本体は [app/analyze/page.tsx](/body-type-analyzer/app/analyze/page.tsx) です。
...
表示文言の基準は [image-analyzer.ts](/body-type-analyzer/lib/image-analyzer.ts) と [page.tsx](/body-type-analyzer/app/analyze/page.tsx) にある。
...
[source-profiles.ts](/body-type-analyzer/lib/source-profiles.ts)
...
[ranking.json](/body-type-analyzer/public/data/ranking.json)

生成元:
- [ranking-builder.ts](/body-type-analyzer/lib/ranking-builder.ts)
- [ranking-estimates.ts](/body-type-analyzer/lib/ranking-estimates.ts)
- [generate-ranking.mjs](/body-type-analyzer/scripts/generate-ranking.mjs)

ここで重要なのは、ランキング側は診断ページそのものではなく、ランキング用にブレンドした推定値を別で持っていることです。

### 8.3 診断モデル JSON

[diagnosis-model.json](/body-type-analyzer/public/data/diagnosis-model.json)

生成元:
- [generate-diagnosis-model.py](/body-type-analyzer/scripts/generate-diagnosis-model.py)
- [diagnosis-model.ts](/body-type-analyzer/lib/diagnosis-model.ts)
...
[male-ranking-model.json](/body-type-analyzer/public/data/male-ranking-model.json)

生成元:
- [generate-male-ranking-model.py](/body-type-analyzer/scripts/generate-male-ranking-model.py)
...
`local-data/` は [.gitignore](/body-type-analyzer/.gitignore) に入っており、公開リポジトリには乗らない。  
...
参照元: [diagnosis-model.json](/body-type-analyzer/public/data/diagnosis-model.json)
...
参照元は現在の [ranking.json](/body-type-analyzer/public/data/ranking.json) です。
...
- [app/page.tsx](/body-type-analyzer/app/page.tsx)
  - ホームの server entry
  - `ranking.json` を直 import
- [app/analyze/page.tsx](/body-type-analyzer/app/analyze/page.tsx)
  - 診断ページ UI
- [app/credits/page.tsx](/body-type-analyzer/app/credits/page.tsx)
  - 画像クレジット表示

### 11.2 コンポーネント

- [HomePageClient.tsx](/body-type-analyzer/components/HomePageClient.tsx)
  - ホーム UI 本体
  - 20件ページ送り
  - 分布 2 系列表示
- [Header.tsx](/body-type-analyzer/components/Header.tsx)
- [Footer.tsx](/body-type-analyzer/components/Footer.tsx)

### 11.3 ランキングロジック

- [ranking-builder.ts](/body-type-analyzer/lib/ranking-builder.ts)
- [ranking-estimates.ts](/body-type-analyzer/lib/ranking-estimates.ts)
- [profile-estimates.ts](/body-type-analyzer/lib/profile-estimates.ts)
- [distributions.ts](/body-type-analyzer/lib/distributions.ts)

### 11.4 診断ロジック

- [image-analyzer.ts](/body-type-analyzer/lib/image-analyzer.ts)
  - ブラウザ側の特徴量抽出
  - 診断テキスト
- [diagnosis-model.ts](/body-type-analyzer/lib/diagnosis-model.ts)
  - 学習済み JSON を読む
...
- [source-profiles.ts](/body-type-analyzer/lib/source-profiles.ts)
  - 公開プロフィール母集団
- [image-credits.json](/body-type-analyzer/public/data/image-credits.json)
  - 画像クレジット
- [celebrities.json](/body-type-analyzer/public/data/celebrities.json)
...
- [generate-diagnosis-model.py](/body-type-analyzer/scripts/generate-diagnosis-model.py)
- [generate-male-ranking-model.py](/body-type-analyzer/scripts/generate-male-ranking-model.py)
- [fetch-local-training-profiles.mjs](/body-type-analyzer/scripts/fetch-local-training-profiles.mjs)
- [fetch-wikipedia-ranking-images.mjs](/body-type-analyzer/scripts/fetch-wikipedia-ranking-images.mjs)
- [fetch-missing-profile-images.mjs](/body-type-analyzer/scripts/fetch-missing-profile-images.mjs)
- [fetch-openverse-profile-images.mjs](/body-type-analyzer/scripts/fetch-openverse-profile-images.mjs)
- [fetch-source-profiles.mjs](/body-type-analyzer/scripts/fetch-source-profiles.mjs)
...
- [app/__tests__/page.test.tsx](/body-type-analyzer/app/__tests__/page.test.tsx)
- [app/__tests__/analyze.test.tsx](/body-type-analyzer/app/__tests__/analyze.test.tsx)
- [app/__tests__/cup-data.test.ts](/body-type-analyzer/app/__tests__/cup-data.test.ts)
- [app/__tests__/cup-distribution-ranking.test.ts](/body-type-analyzer/app/__tests__/cup-distribution-ranking.test.ts)
- [components/__tests__/Header.test.tsx](/body-type-analyzer/components/__tests__/Header.test.tsx)
- [components/__tests__/Footer.test.tsx](/body-type-analyzer/components/__tests__/Footer.test.tsx)
- [lib/__tests__/statistics.test.ts](/body-type-analyzer/lib/__tests__/statistics.test.ts)
- [lib/__tests__/profile-estimates.test.ts](/body-type-analyzer/lib/__tests__/profile-estimates.test.ts)
- [lib/__tests__/image-analyzer.test.ts](/body-type-analyzer/lib/__tests__/image-analyzer.test.ts)
- [lib/__tests__/diagnosis-model.test.ts](/body-type-analyzer/lib/__tests__/diagnosis-model.test.ts)
- [lib/__tests__/distributions.test.ts](/body-type-analyzer/lib/__tests__/distributions.test.ts)
