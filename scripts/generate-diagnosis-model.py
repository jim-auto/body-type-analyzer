...
def weighted_average(neighbors: list[tuple[float, float]]) -> int:
...
def evaluate_height(
    ...
    for index in height_indices:
        ...
        for feature_name, neighbor_count in HEIGHT_MODELS:
...
def evaluate_cup(
    ...
    for index in cup_indices:
        ...
        for feature_name, neighbor_count in CUP_MODELS:
            neighbors = get_neighbors(
                named_feature_sets[feature_name],
                cups,
                index,
...
def build_model() -> dict[str, object]:
    ...
    return {
        ...
        "metrics": {
            ...
            "height": {
                "strategy": "median ensemble of 3 kNN regressors",
                **evaluate_height(feature_sets, heights, height_indices),
            },
            "cup": {
                "strategy": "2-model vote with center-biased tie break",
                **evaluate_cup(feature_sets, cups, cup_indices),
            },
            "similarity": {
